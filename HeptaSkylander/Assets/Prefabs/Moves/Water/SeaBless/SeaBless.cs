...
public class SeaBless : Move
{
    ...
    public override void Trigger()
    {
        ...
        if (target)
        {
            ...
            SeaBlessProjectile projectile = Instantiate(moveObject, user.transform.position, user.transform.rotation).GetComponent<SeaBlessProjectile>();
